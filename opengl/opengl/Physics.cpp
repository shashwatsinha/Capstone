...
bool Physics::DetectCollision(btCollisionObject* target1, btCollisionObject* target2, Physics*physics, std::vector<ActorFactory*> physicsGameObjects)
{
...
//detect collision, by pairs, most efficient... find collision for particular object
void Physics::DetectCollision(Physics*physics, std::vector<ActorFactory*> physicsGameObjects)
{
